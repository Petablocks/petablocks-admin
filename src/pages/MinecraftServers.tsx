                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {srv.telemetrySource === 'websocket-mod' ? (
                        ...
                        ) : srv.telemetrySource === 'spark-profiler' ? (
                      ...
                      <h3 className="font-bold text-base mt-1 text-foreground group-hover:text-primary transition-colors flex items-center justify-between">
                        <span>{srv.name}</span>
